...
train_rates=("25" "50" "75" "100")                          # "0.01" "0.05" "0.1" "0.25" "0.5" "1.0" "05" "10" "25" "50" "75" "100"
                    ...
                    for m in "${models[@]}"; do
                        ...
                        if [ "$m" = "Supervised" ]; then
                            for iw in "${ini_weights[@]}"; do
                                ...
                                raytune_args="--exp-name ${tr}_${d}_${tl}_${s}_${m}_${iw} --partition volta --num-nodes 1 --node aap04 --num-gpus 4 --load-env \"ssl-bsu-conda\" --command \"$command_arg\"" # --node aap04 
