...
#SBATCH --job-name=05_multilabel_LP_42_Supervised_random_0106-2349
#SBATCH --output=05_multilabel_LP_42_Supervised_random_0106-2349.log
#SBATCH -w aap04
...
torchrun finetuning.py Supervised multilabel -bn resnet18 -tr 05 -e 100 -lr 0.01 -se 5 -bs 32 -nw 4 -iw random -tl LP -s 42 --ray_tune=gridsearch --grace_period=75 --num_samples_trials=1 --gpus_per_trial=1