...
#SBATCH --job-name=05_multiclass_LP_42_Supervised_imagenet_0106-2349
#SBATCH --output=05_multiclass_LP_42_Supervised_imagenet_0106-2349.log
#SBATCH -w aap04
...
torchrun finetuning.py Supervised multiclass -bn resnet18 -tr 05 -e 100 -lr 0.01 -se 5 -bs 32 -nw 4 -iw imagenet -tl LP -s 42 --ray_tune=gridsearch --grace_period=75 --num_samples_trials=1 --gpus_per_trial=1